...
public class LinkedListDequeTest {
    ...
    public void ranfomizedTest(){
        ...
        for (int i = 0; i < N; i += 1) {
            ...
            if (operationNumber == 0) {
                ...
                int ba_remmoveFirst=BA.removeFirst();
                System.out.println("removelast: "+removeFirst);
                assertEquals(removeFirst,ba_remmoveFirst);
    ...
    public static void main(String[] args) {
        LinkedListDequeTest L = new LinkedListDequeTest();
        L.addIsEmptySizeTest();
        L.addRemoveTest();
        L.removeEmptyTest();
        L.multipleParamTest();
        L.emptyNullReturnTest();
        L.bigLLDequeTest();
        L.ranfomizedTest();
    }
}
